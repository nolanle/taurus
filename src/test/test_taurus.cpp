...
#define BOOST_TEST_MODULE Taurus Test Suite

#include "test_taurus.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_taurus_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
