    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Taurus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Taurus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and taurus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Taurus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Taurus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Taurus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Taurus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Taurus addresses"));
    ...
    openAction->setStatusTip(tr("Open a taurus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Taurus Core help message to get a list with possible Taurus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Taurus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Taurus network", "", count));
    } else {
...
{
    QString strTitle = tr("Taurus Core"); // default title
