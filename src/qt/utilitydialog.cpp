    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Taurus Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Taurus Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  taurus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Taurus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TAP, 0.1 TAP, 1 TAP and 10 TAP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://tauruspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://tauruspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Taurus Core is shutting down...") + "<br /><br />" +
