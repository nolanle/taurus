    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TAP-light"), QVariant("light"));
    ui->theme->addItem(QString("TAP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TAP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TAP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TAP-traditional"), QVariant("trad"));
