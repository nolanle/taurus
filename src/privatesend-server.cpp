...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Taurus related functionality
...
/*
    ...
    allow endless transaction that would bloat Taurus and make it unusable. To
