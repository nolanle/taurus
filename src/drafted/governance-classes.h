 ...
 *
 *   // network
 *   CTaurusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.taurus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTaurusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TaurusNetwork
// //   -- signature requirements : Key1(User)
// class CTaurusNetworkVariable : public CGovernanceObject
// {
// private:
