...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TaurusNetwork") type = TaurusNetwork;
    if(strType == "TaurusNetworkVariable") type = TaurusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TaurusNetwork) s = "TaurusNetwork";
    if(type == TaurusNetworkVariable) s = "TaurusNetworkVariable";
