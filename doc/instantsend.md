...
This mechanism has been integrated into Bitcore-Node-Taurus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tauruspay/insight-api-taurus#web-socket-api](https://github.com/tauruspay/insight-api-taurus#web-socket-api)
* API: [https://github.com/tauruspay/insight-api-taurus#instantsend-transactions](https://github.com/tauruspay/insight-api-taurus#instantsend-transactions)
...
By default, the Taurus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Taurus Core daemon:
