...
Only requiring some minor changes is taurus.cpp.
...
Changes to taurus.cpp
----------------------
taurus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
